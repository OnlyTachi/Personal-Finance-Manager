...
export default function PassivosPage() {
  ...
  const inputClass =
    "w-full bg-slate-900 border border-slate-600 rounded p-2 text-white outline-none";
    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between border-b border-slate-700 pb-2">
                  ...
                  <span className="font-bold text-red-400">
                    R${" "}
                    {p.saldo_devedor.toLocaleString("pt-BR", {
                ...
                <div className="flex justify-between">
                  ...
                  <span className="flex items-center gap-1 text-yellow-400">
                    <Percent className="w-3 h-3" /> {p.taxa_juros_anual}% a.a.
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span>
                    R${" "}
                    {p.valor_parcela.toLocaleString("pt-BR", {
                      minimumFractionDigits: 2,
                    })}
                  </span>
                </div>
          ...
          {passivos.length === 0 && (
            <div className="col-span-full text-center py-10 text-gray-500 border border-dashed border-slate-700 rounded-xl">
              Nenhuma dívida cadastrada (Ufa!).
            </div>
          )}
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
          <div className="bg-surface p-6 rounded-xl border border-slate-700 w-full max-w-md">
            ...
            <form onSubmit={handleSave} className="space-y-4">
              <input
                required
                placeholder="Nome (ex: Financiamento Casa)"
                value={form.nome}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, saldo_devedor: e.target.value })
                  }
                  className={inputClass}
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, taxa_juros_anual: e.target.value })
                  }
                  className={inputClass}
                />
                <input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, prazo_meses: e.target.value })
                  }
                  className={inputClass}
                />
              </div>
